...
<html>
    ...
    <body>
        ...
        <div id="header" class="skel-panels-fixed">
            ...
            <div class="top">
                ...
                <div id="logo">
                    ...
                    <h1 id="title">Yelerol</h1>
                    <span class="byline">Camping an der Loreley</span>
                </div>

                <!-- Nav -->
                <nav id="nav">
                    <ul>
                        <li><a href="#top" id="top-link" class="skel-panels-ignoreHref"><span class="icon icon-home">Start</span></a></li>
                        <li><a href="#blog" id="blog-link" class="skel-panels-ignoreHref"><span class="icon icon-book">Blog</span></a></li>
                        <!--<li><a href="#galerie" id="top-link" class="skel-panels-ignoreHref"><span class="icon icon-camera">Galerie</span></a></li>-->
                        <li><a href="#wetter" id="wetter-link" class="skel-panels-ignoreHref"><span class="icon icon-sun">Wetter</span></a></li>
                        <li><a href="#ausfluege" id="ausfluege-link" class="skel-panels-ignoreHref"><span class="icon icon-flag-checkered">Ausflüge</span></a></li>
                        <li><a href="#packliste" id="packliste-link" class="skel-panels-ignoreHref"><span class="icon icon-check">Packliste</span></a></li>
                        <li><a href="#abrechnung" id="abrechnung-link" class="skel-panels-ignoreHref"><span class="icon icon-exchange">Abrechnung</span></a></li>
        ...
        <div id="footer">
            ...
            <!-- Copyright -->
            <div class="copyright">
                <p>&copy; 2013 Yelerol. All rights reserved.</p>
                <ul class="menu">
